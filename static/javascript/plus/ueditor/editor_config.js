...
(function () {
    ...
    //var URL = 'http://127.0.0.1:8000/static/javascript/plus/ueditor/';
    //D:\Test\DjangoWeb\mysite\static\javascript\plus\ueditor
    var tmp = window.location.pathname,
        URL= 'http://127.0.0.1:8000/static/javascript/plus/ueditor/';           //这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    UEDITOR_CONFIG = {
        //imagePath:URL + "server/upload/", //图片文件夹所在的路径，用于显示时修正后台返回的图片url！具体图片保存路径需要在后台设置。！important
        imagePath:"http://127.0.0.1:8000",		//后边的/media/uploadimg/2012/03/c6ec2140-717d-11e1-9021-005056c00008.png具体图片地址会自动加上的！！！！！！wangliang
